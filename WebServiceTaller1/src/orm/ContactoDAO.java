...
public class ContactoDAO {
	public static Contacto loadContactoByORMID(int uid) throws PersistentException {
		try {
			PersistentSession session = orm.Taller1PersistentManager.instance().getSession();
	...
	public static boolean save(orm.Contacto contacto) throws PersistentException {
		try {
			orm.Taller1PersistentManager.instance().saveObject(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Contacto lormContacto) throws PersistentException {
		try {
			orm.Taller1PersistentManager.instance().deleteObject(lormContacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Contacto contacto) throws PersistentException {
		try {
			orm.Taller1PersistentManager.instance().getSession().refresh(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Contacto contacto) throws PersistentException {
		try {
			orm.Taller1PersistentManager.instance().getSession().evict(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
