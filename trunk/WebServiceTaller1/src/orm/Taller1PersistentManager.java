...
public class Taller1PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Taller1";
	...
	private Taller1PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Taller1PersistentManager();
		}
