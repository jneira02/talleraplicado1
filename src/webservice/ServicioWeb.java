...
public class ServicioWeb {
	...
	public String registrarAdministrador(domain.AdministradorVO oAdministradorVO2){
		PersistentTransaction t;

		Gson gson = new Gson();


		AdministradorVO oTestVO = new AdministradorVO("adminJ123","adminJ123");
		String testJSON = gson.toJson(oTestVO);


		AdministradorVO oAdministradorVO = gson.fromJson(testJSON, AdministradorVO.class);
		
		System.out.println("ADMIN EN JSON"+testJSON);
		System.out.println("OBJ\nUSER: "+oTestVO.getUser()+"\nPASS: "+oTestVO.getPassword());
