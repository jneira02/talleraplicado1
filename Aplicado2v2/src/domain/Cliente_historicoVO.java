...
public class Cliente_historicoVO {
 ...
 public ClientesVO getClienteVO() {
         return clienteVO;
 }
 public void setClienteVO(ClientesVO clienteVO) {
 ...
 public Cliente_historicoVO(String rut, String nombres,
                 ...
                 LoginVO loginVO, ClientesVO clienteVO) {
         super();
         this.rut = rut;
         this.nombres = nombres;
         this.apellido_materno = apellido_materno;
...
public Cliente_historicoVO(int id_cliente_hist, String rut, String nombres,
		String apellido_materno, String apellido_paterno, String telefono,
		String email, String direccion, String fecha_modificacion,
		LoginVO loginVO, ClientesVO clienteVO) {
	super();
	this.id_cliente_hist = id_cliente_hist;
	this.rut = rut;
	this.nombres = nombres;
	this.apellido_materno = apellido_materno;
	this.apellido_paterno = apellido_paterno;
