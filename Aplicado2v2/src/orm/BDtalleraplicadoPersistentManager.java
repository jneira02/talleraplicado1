...
public class BDtalleraplicadoPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "BDtalleraplicado";
	...
	private BDtalleraplicadoPersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(orm.Consumo.class);
		configuration.addAnnotatedClass(orm.Login.class);
		configuration.addAnnotatedClass(orm.Administrador.class);
		configuration.addAnnotatedClass(orm.Cliente_historico.class);
		configuration.addAnnotatedClass(orm.Cuenta.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new BDtalleraplicadoPersistentManager();
		}
