...
public class AdministradorDAO {
	public static Administrador loadAdministradorByORMID(int id_administrador) throws PersistentException {
		try {
			PersistentSession session = orm.BDtalleraplicadoPersistentManager.instance().getSession();
			return loadAdministradorByORMID(session, id_administrador);
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static Administrador getAdministradorByORMID(int id_administrador) throws PersistentException {
		try {
			PersistentSession session = orm.BDtalleraplicadoPersistentManager.instance().getSession();
			return getAdministradorByORMID(session, id_administrador);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(int id_administrador, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = orm.BDtalleraplicadoPersistentManager.instance().getSession();
			return loadAdministradorByORMID(session, id_administrador, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(int id_administrador, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = orm.BDtalleraplicadoPersistentManager.instance().getSession();
			return getAdministradorByORMID(session, id_administrador, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, int id_administrador) throws PersistentException {
		try {
			return (Administrador) session.load(orm.Administrador.class, new Integer(id_administrador));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, int id_administrador) throws PersistentException {
		try {
			return (Administrador) session.get(orm.Administrador.class, new Integer(id_administrador));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, int id_administrador, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.load(orm.Administrador.class, new Integer(id_administrador), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, int id_administrador, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.get(orm.Administrador.class, new Integer(id_administrador), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(orm.Administrador administrador) throws PersistentException {
		try {
			orm.BDtalleraplicadoPersistentManager.instance().saveObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Administrador administrador) throws PersistentException {
		try {
			orm.BDtalleraplicadoPersistentManager.instance().deleteObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Administrador administrador)throws PersistentException {
		try {
			...
			for(int i = 0; i < lLogins.length; i++) {
				lLogins[i].setId_administrador(null);
			}
	...
	public static boolean refresh(orm.Administrador administrador) throws PersistentException {
		try {
			orm.BDtalleraplicadoPersistentManager.instance().getSession().refresh(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Administrador administrador) throws PersistentException {
		try {
			orm.BDtalleraplicadoPersistentManager.instance().getSession().evict(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
